...
function showDateScreen() {
  ...
  document.body.innerHTML = `
    <main class="welcome-screen">
      <div class="birthday-card">
        ...
        <button class="back-button" id="backToStep1">
          ← Back
        </button>
        ...
        <p class="message">
          Your birthday is September 5th, but you can choose
        ...
        <div
          ...
          <p class="saved-choice" id="savedDateText"></p>
  ...
  dateChoices.forEach(function (button) {
    ...
    if (button.dataset.date === birthdayPlan.dates) {
      button.classList.add("selected");
      showContinueButton();
    }
  ...
  document.body.innerHTML = `
    <main class="welcome-screen">
      ...
      <div class="birthday-card">
        ...
        <button class="back-button" id="backToDates">
          ← Back
        </button>
